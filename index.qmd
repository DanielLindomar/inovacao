...
As **aulas** argumentam. Cada página traz por extenso o conteúdo de um bloco da disciplina — parte discutido ao vivo, parte lido por sua conta: o raciocínio, os exemplos, os números. Você lê antes para chegar preparado e depois para revisar — a aula não é a única chance de aprender aquilo.
...
| | |
|---|---|
| **Encontros síncronos** | **Sábado 12/09, das 8h às 12h**, e **sábado 26/09, das 14h às 18h**, por Google Meet |
| **Fora dos encontros** | 22 horas de leitura, laboratórios e produção do trabalho final, no seu ritmo — o [roteiro de estudos](roteiro.qmd) diz o que fazer em cada semana |
...
Nos encontros **não se repete o que já está escrito aqui**. O tempo ao vivo é para as atividades com solução, a leitura de um edital real e as quatro oficinas do plano de captação — o trabalho final, escrito em partes ao longo dos dois encontros. Quem chega sem ter lido acompanha pior — e essa é a regra, não a punição.
...
| [Casos reais](casos-reais.qmd) | Oito histórias verdadeiras, uma por porta: subvenção, EMBRAPII, crédito, equity e Lei do Bem, com fonte e data |
...
| [Mapa de instrumentos](atividade-mapa.qmd) | Atividade com solução do primeiro sábado — seis situações e a porta certa para cada uma |
| [O caso da Lei do Bem](caso-lei-do-bem.qmd) | Atividade com solução do primeiro sábado — quatro números e o contrafactual |
| [Esta empresa pode usar a Lei do Bem?](atividade-elegibilidade.qmd) | Atividade com solução do segundo sábado — seis perfis e o teste de elegibilidade |
...
**Comece pelo [Roteiro de estudos](roteiro.qmd).** Ele diz o que fazer em cada semana, quanto tempo cada coisa leva e para onde ir no site — as 22 horas assíncronas, distribuídas.

**Antes de cada encontro**, leia as quatro páginas de aula daquele sábado. São textos, não slides — foram escritos para serem lidos sozinho, e o encontro parte do princípio de que foram lidos.

**Nos laboratórios**, rode os blocos **na ordem**: os primeiros carregam os dados usados pelos seguintes. Não há nada para digitar — cada bloco vem pronto; o trabalho é rodar, olhar a saída e ler a nota *Como ler* logo abaixo.
